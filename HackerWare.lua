...
local function createCommandBarCmd(Name,Args)
	if Name and Args then 
		...
		CmdBarTextLabel.TextColor3 = Color3.fromRGB(0,255,0)
...
local function createCmd(Pos,CommandName,CommandInfo,CommandArgs)
	...
	CommandLabel.TextColor3 = Color3.fromRGB(0,255,0)
			...
			if TriggerBot then 
				...
				if AnnoyingPlayer and AnnoyingPlayer.Character and not AnnoyingPlayer.Character:FindFirstChild('Bone',true) and (not BuyingStuff and TriggerBotAutoReload or not TriggerBotAutoReload) then
					if Character:FindFirstChild'Glock' or Character:FindFirstChild'Uzi' then
						...
						if Random <= 3 then 
							PartFound.CFrame = Part.CFrame * CFrame.new(math.random(0,12),0,math.random(0,12))
						elseif Random > 3 then 
							PartFound.CFrame = Part.CFrame * CFrame.new(-math.random(0,12),0,-math.random(1,12))
						end
					else
						local Random = math.random(1,6)
						if Random <= 3 then 
							PartFound.CFrame = Part.CFrame * CFrame.new(math.random(0,5),0,math.random(0,5))
						elseif Random > 3 then 
							PartFound.CFrame = Part.CFrame * CFrame.new(-math.random(0,5),0,-math.random(0,5))
						end 
					end
...
repeat
    ...
    HRP.CFrame = HRP.CFrame * CFrame.new(0, 2, 0)
    wait()
    HRP.CFrame = HRP.CFrame * CFrame.new(0, -2, 1)
    wait()
    HRP.CFrame = HRP.CFrame * CFrame.new(0, 2, 0)
    wait()
    HRP.CFrame = HRP.CFrame * CFrame.new(0, -2, 0)
...
AddCommand(function(Arguments)
	if Arguments[1] and Arguments[2] and tonumber(Arguments[2]) then
		if Arguments[1] == "down" then 
			...
			LP.PlayerGui.Chat.Frame.ChatBarParentFrame.Position = LP.PlayerGui.Chat.Frame.ChatChannelParentFrame.Position + UDim2.new(UDim.new(),LP.PlayerGui.Chat.Frame.ChatChannelParentFrame.Size.Y + UDim.new(0,2))
...
coroutine.resume(coroutine.create(function()
	...
	RainbowLabel.BackgroundTransparency = 0.1
	RainbowLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	RainbowLabel.TextColor3 = Color3.fromRGB(0,255,0)
	RainbowLabel.TextSize = 50

	RainbowScrolling.BackgroundColor3 = Color3.fromRGB(17,17,17)
	RainbowScrolling.BackgroundTransparency = 0.1
	RainbowScrolling.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdsFrame.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdsLabel.BackgroundTransparency = 0.1
	CmdsLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdsLabel.TextColor3 = Color3.fromRGB(0,255,0)
	CmdsLabel.TextSize = 20
	
	CmdsScrolling.Active = true
	CmdsScrolling.BackgroundColor3 = Color3.fromRGB(17,17,17)
	CmdsScrolling.BackgroundTransparency = 0.1
	CmdsScrolling.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdBarFrame.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdBarTextBox.BackgroundTransparency = 0.1
	CmdBarTextBox.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdBarTextBox.TextColor3 = Color3.fromRGB(0,255,0)
	...
	ValuesFrame.BackgroundTransparency = 0.1
	ValuesFrame.Position = UDim2.new(0.002,1.5,0.656,0)
	ValuesFrame.AnchorPoint = Vector2.new(0,1)
	ValuesFrame.Size = UDim2.new(0,160,0,265)
	
	ValuesTextLabel.BackgroundColor3 = Color3.fromRGB(17,17,17)
	ValuesTextLabel.BackgroundTransparency = 0.1
	ValuesTextLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	ValuesTextLabel.Position = UDim2.new(0,0,0,0)
	ValuesTextLabel.Size = UDim2.new(0,160,0,265)
	ValuesTextLabel.Font = Enum.Font.Code
	ValuesTextLabel.TextColor3 = Color3.fromRGB(0,255,0)
	...
	HotkeysFrame.Position = UDim2.new(0.085,2,0,718)
	...
	HotkeysTextLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	HotkeysTextLabel.TextColor3 = Color3.fromRGB(0,255,0)
	...
	DmgIndicator.BackgroundTransparency = 1
	...
	DmgIndicator.TextColor3 = Color3.fromRGB(0,255,0)
	...
	KeysFrame.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	AnyCmdButton.BackgroundTransparency = 1
	AnyCmdButton.BorderColor3 = Color3.fromRGB(0,255,0)
	AnyCmdButton.Position = UDim2.new(0.17,0,0.43,0)
	AnyCmdButton.Size = UDim2.new(0,49,0,49)
	AnyCmdButton.Font = Enum.Font.SourceSans
	AnyCmdButton.TextColor3 = Color3.fromRGB(0,255,0)
	...
	KeysLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	KeysLabel.TextColor3 = Color3.fromRGB(0,255,0)
	KeysLabel.TextSize = 50
	
	CmdBarKeyLabel.BackgroundColor3 = Color3.fromRGB(17,17,17)
	CmdBarKeyLabel.BackgroundTransparency = 1
	CmdBarKeyLabel.BorderColor3 = Color3.fromRGB(0,255,0)
	...
	CmdBarKeyLabel.TextColor3 = Color3.fromRGB(0,255,0)
	CmdBarKeyLabel.TextSize = 11
	CmdBarKeyLabel.TextWrapped = true
	
	CmdBarKeyButton.BackgroundColor3 = Color3.fromRGB(17,17,17)
	CmdBarKeyButton.BackgroundTransparency = 1
	CmdBarKeyButton.BorderColor3 = Color3.fromRGB(0,255,0)
...
coroutine.resume(coroutine.create(function()
	while wait(1) do
		if CmdBarKey == "Quote" then 
			HotkeysTextLabel.Text = "HackerWare"
		else
			HotkeysTextLabel.Text = "HackerWare"
		end
...
ClipsTxt.Text = "Clips:"
ClipsTxt.TextColor3 = Color3.fromRGB(0,255,0)
ClipsTxt.TextSize = 14.000
    ...
    c.Chatted:Connect(
        function(d)
            if string.find(d, "/e ") or string.find(d, "/w ") or string.find(d, "/whisper ") then
                tltRD("{SPY}: " .. "[" .. tostring(c) .. "]: " .. d, Color3.new(0,255,0))
            end
        end
    )
end
...
Ping.BackgroundTransparency = 0.1
Ping.BorderColor3 = Color3.fromRGB(0,255,0)
Ping.BorderSizePixel = 1.5
Ping.Position = UDim2.new(0.0091, 0, 0.360, 0)
